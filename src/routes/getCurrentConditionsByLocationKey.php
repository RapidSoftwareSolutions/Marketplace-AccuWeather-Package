...
$app->post('/api/AccuWeather/getCurrentConditionsByLocationKey', function ($request, $response) {
    ...
    $query_str = "http://dataservice.accuweather.com/currentconditions/v1/{$data['locationKey']}.json";
