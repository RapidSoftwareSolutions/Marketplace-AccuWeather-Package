...
$app->post('/api/AccuWeather/get24HoursConditionsByLocationKey', function ($request, $response) {
    ...
    $query_str = "http://dataservice.accuweather.com/currentconditions/v1/{$data['locationKey']}/historical/24.json";
