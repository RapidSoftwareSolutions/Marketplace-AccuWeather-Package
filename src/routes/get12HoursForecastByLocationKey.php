...
$app->post('/api/AccuWeather/get12HoursForecastByLocationKey', function ($request, $response) {
    ...
    $query_str = "http://dataservice.accuweather.com/forecasts/v1/hourly/12hour/{$data['locationKey']}.json";
