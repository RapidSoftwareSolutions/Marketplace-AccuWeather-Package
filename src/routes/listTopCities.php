...
$app->post('/api/AccuWeather/listTopCities', function ($request, $response) {
    ...
    $query_str = "http://dataservice.accuweather.com/locations/v1/topcities/{$data['group']}.json";
