...
$app->post('/api/AccuWeather/get5MinutesForecastByCoordinates', function ($request, $response) {
    ...
    $query_str = "http://dataservice.accuweather.com/forecasts/v1/minute/5minute.json";
