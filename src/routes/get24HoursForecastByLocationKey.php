...
$app->post('/api/AccuWeather/get24HoursForecastByLocationKey', function ($request, $response) {
    ...
    $query_str = "http://dataservice.accuweather.com/forecasts/v1/hourly/24hour/{$data['locationKey']}.json";
