...
$app->post('/api/AccuWeather/get240HoursForecastByLocationKey', function ($request, $response) {
    ...
    $query_str = "http://dataservice.accuweather.com/forecasts/v1/hourly/240hour/{$data['locationKey']}.json";
