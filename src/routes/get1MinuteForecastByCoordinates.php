...
$app->post('/api/AccuWeather/get1MinuteForecastByCoordinates', function ($request, $response) {
    ...
    $query_str = "http://dataservice.accuweather.com/forecasts/v1/minute/1minute.json";
