...
$app->post('/api/AccuWeather/getMonthClimoSummaryByLocationKey', function ($request, $response) {
    ...
    $query_str = "http://dataservice.accuweather.com/climo/v1/summary/{$data['date']}/{$data['locationKey']}.json";
