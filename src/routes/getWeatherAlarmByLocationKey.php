...
$app->post('/api/AccuWeather/getWeatherAlarmByLocationKey', function ($request, $response) {
    ...
    $query_str = "http://dataservice.accuweather.com/alarms/v1/{$data['days']}/{$data['locationKey']}.json";
